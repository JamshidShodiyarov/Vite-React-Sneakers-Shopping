...
const Clips = ({ clip, imgsrc }) => {
	return (
		<div className="relative h-20 w-24 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14">
			<img
				src={imgsrc}
				alt="img/clips"
			...
			/>
			<div className="bg-white blur-effect-theme absolute top-11 left-11 lg:top-8 lg:left-9 sm:left-5 sm:top-4  right-0 opacity-100 z-[100] w-8 h-8 md:h-5 md:w-5 flex items-center justify-center rounded-full">
