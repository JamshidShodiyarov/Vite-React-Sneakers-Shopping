...
import { setRemoveItemFromCart, setDecreaseItemQTY, setIncreaseItemQTY } from '../../app/CartSlice';

function CartItem({ item: { id, title, text, img, color, shadow, cartQuantity, price } }) {
	...
	const onRemoveItem = () => {
		...
		dispatch(setRemoveItemFromCart(obj));
	};
	const onDecreaseItemQTY = () => {
		dispatch(setDecreaseItemQTY({ id, title, text, img, color, shadow, cartQuantity, price }));
	};
	const onIncreaseItemQTY = () => {
		dispatch(setIncreaseItemQTY({ id, title, text, img, color, shadow, cartQuantity, price }));
	};
	return (
		<>
